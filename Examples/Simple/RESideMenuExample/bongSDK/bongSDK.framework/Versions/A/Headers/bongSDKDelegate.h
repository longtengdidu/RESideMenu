 ...
 *  @param errorCode 为 `bongSDKErrorCodeNone` 表示返回成功
 */
- (void)bongSDKDidFetchbongID:(bongSDKErrorCode)errorCode;
/**
 ...
 *  bong X/XX 按键开关结果回调
 *
 *  @param error nil，设置成功，反之失败
 */
- (void)bongSDKDidSwitchXNote:(NSError *)error;
/**
 *  bong X/XX 按键回调
 *
 *  @param type  详细见 bongSDKXNoteType
 *  @param error nil，返回正常
 */
- (void)bongSDKDidUpdateXNote:(bongSDKXNoteType)type error:(NSError *)error;
