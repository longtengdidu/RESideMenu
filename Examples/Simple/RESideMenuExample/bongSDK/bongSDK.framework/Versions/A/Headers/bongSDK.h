 ...
 *  bong 产品 ID
 *
 *  产品 ID 用作区分 bong 的产品型号
 */
+ (bongSDKProductID)bongProductID;
/**
 *  bongSDK 开启扫描
 *
 ...
 *  bongII 手环目前可以存储 7 天数据，bong X/XX 手表则为 3 天
 *
 *  @param start 起始日期
 *  @param end   结束日期
 */
+ (void)fetchbongDataWithStartDate:(NSDate *)start endDate:(NSDate *)end;
/**
 *  获取 bong 的天活动数据
 *
 *  @param date       获取日期
...
/**
 *  设置 bong X/XX 触摸事件通知开G
 *
 *  @param enable YES，开启；NO，关闭
 */
+ (void)enableXNote:(BOOL)enable;
