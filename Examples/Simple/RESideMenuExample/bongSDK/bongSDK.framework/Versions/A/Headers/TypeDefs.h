...
typedef NS_ENUM(int, bongSDKErrorCode){
     ...
     *  接口调用错误
     */
    bongSDKErrorCodeInvalidAPI,
    /**
     *  产品 ID 不支持
     */
    bongSDKErrorCodeInvalidProductID,
    /**
     *  bong X/XX 事件通知错误
     */
    bongSDKErrorCodeXNoteError,
    /**
     *  意外断开设备
     */
    bongSDKErrorCodeUnexpectedDisconnection,
    /**
     *  网络连接错误
     */
 ...
 *  bong 产品 ID
 */
typedef NS_ENUM(NSInteger, bongSDKProductID){
    /**
     *  无产品 ID
     */
    bongSDKProductIDNone = 0,
    /**
     *  bong II
     */
    bongSDKProductIDTwo = 101002,
    /**
     *  bong X
     */
    bongSDKProductIDX = 101003,
    /**
     *  bong XX
     */
    bongSDKProductIDXX = 101004,
};
 ...
 *  bong X/XX 按键通知类型
 */
typedef NS_ENUM(NSInteger, bongSDKXNoteType){
    /**
     *  无类型
     */
    bongSDKXNoteTypeNone = 0,
    /**
     *  向上滑动
     */
    bongSDKXNoteTypeSwipeUp = 6,
    /**
     *  向下滑动
     */
    bongSDKXNoteTypeSwipeDown = 7,
    /**
     *  向左滑动
     */
    bongSDKXNoteTypeSwipeLeft = 8,
    /**
     *  向右滑动
     */
    bongSDKXNoteTypeSwipeRight = 9,
    /**
     *  入睡
     */
    bongSDKXNoteTypeSleepIn = 12,
    /**
     *  起床
     */
    bongSDKXNoteTypeSleepOut = 13,
    /**
     *  进入 bong 状态
     */
    bongSDKXNoteTypebongIn = 14,
    /**
     *  退出 bong 状态
     */
    bongSDKXNoteTypebongOut = 15,
    /**
     *  长按
     */
    bongSDKXNoteTypeLongPress = 25,
};
...
typedef NS_ENUM(int, bongSDKDataFetchStatus){
     ...
     *  通讯成功，但设备上并未有此段数据
     */
    bongSDKDataFetchStatusFetchNothing,
};
